...
import { stringify } from "querystring";
  ...
  export default function FilterMenu({ bol, fun2, fun, lista, listLength}:{bol:Function, fun2:Function, lista:Array<string>, listLength:number, fun:Function}) {
    ...
    return (
      ...
      >
              ...
              <Checkbox className='justify-self-end' id={item} onClick={e=>handler(item)}/>
            </MenubarMenu>
          ))}
        </Menubar>
      );}