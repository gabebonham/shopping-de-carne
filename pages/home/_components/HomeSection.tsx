...
export default function HomeSection({
	...
	return (
		<div className={'' + className}>
			<Card
				className={
					'grid grid-cols-3 gap-y-24  py-12 w-auto rounded-none outline-none justify-items-center'
				}
			>
				{items.map(
					(p, i) =>
						p.show && (
							...
							>
								<Card
									className={
										'transition hover:-translate-y-1.5 animate-fadeIn size-52 grid grid-cols-1 grid-rows-2 shadow-lg border-0 outline-none '
									}
								>
